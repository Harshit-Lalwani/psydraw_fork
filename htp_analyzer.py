...
class HTPAnalyzer:
    ...
    def load_ui_texts(self):
        ...
        return {
            ...
            # Chinese strings removed — English only
        }
...
"""
    ...
    def create_language_selector(self, parent):
        ...
        # Language toggles removed (English-only)
        ttk.Label(lang_frame, text="English").grid(row=0, column=1, padx=5)
    ...
    def create_api_config(self, parent):
        ...
        # 添加说明文字
        help_text = "Please enter your Google Gemini API key / 请输入您的Google Gemini API密钥"
        ttk.Label(
            api_frame,
            text=help_text,
            wraplength=400,
        ...
        self.api_key.grid(row=1, column=1, padx=5, sticky=(tk.W, tk.E))
